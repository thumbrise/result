...
use Thumbrise\Toolkit\Tests\Stubs\StubError;
...
class OperationResultTest extends TestCase
{
    ...
    {
        parent::tearDown();
        OperationResult::resetHttpStatusBindings();
        Validator::resetGlobals();
    }
    ...
    #[Test]
    public function properlyMapHttpStatus()
    {
        $statusExpected = 405;
        OperationResult::bindHttpStatuses([
            $statusExpected => [
                StubError::StubCase1,
                StubError::StubCase2,
                StubError::StubCase, // Needed
                StubError::StubCase3,
                StubError::StubCase4,
            ],
            400 => [StubError::StubCase],
            401 => [StubError::StubCase],
            402 => [StubError::StubCase],
        ]);

        Route::get('test', function () {
            return OperationResult::error('Something went wrong', StubError::StubCase);
        });
    ...
    #[Test]
    public function properlyMapHttpStatusCancel()
    {
        $statusExpected = 200;
        OperationResult::bindHttpStatuses([
            405 => [StubError::StubCase],
        ]);

        // Cancel http code mapping.
        OperationResult::bindHttpStatuses();
        Route::get('test', function () {
            return OperationResult::error('Something went wrong', StubError::StubCase);
        });
    ...
    #[Test]
    public function properlyMapHttpStatusValidationDefault()
    {
        $statusExpected = Response::HTTP_UNPROCESSABLE_ENTITY;

        Route::get('test', function () {
            return Validator::validate([], ['some' => ['required']]);
        });
